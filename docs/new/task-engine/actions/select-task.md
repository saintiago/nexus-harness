...
Read a fresh candidate list in configured source order. A recovery target restricts selection to the
named blocker. Do not reserve a batch or reorder by a separate priority rule.
