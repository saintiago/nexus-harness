...
| Task source | Provider connection, project identity, source selection and source field/workflow mappings; idea refinement uses draft, refining, ready-for-design and returned mappings |
